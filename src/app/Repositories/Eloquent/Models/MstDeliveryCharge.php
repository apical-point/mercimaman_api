...
class MstDeliveryCharge extends Bases\BaseModel
{

    protected $table = 'mst_delivery_charges';
    ...
    {
        return $this->belongsTo('App\Repositories\Eloquent\Models\Area');
    }
    // サイズ
    public function size()
    {
        return $this->belongsTo('App\Repositories\Eloquent\Models\MstDeliverySize');
    }
